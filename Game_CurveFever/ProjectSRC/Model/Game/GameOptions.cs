...
namespace Game_CurveFever.ProjectSRC.Model.Game {
    public class GameOptions {
        ...
        public PlayerStartPositions PlayerStartPosition { get; private set; }
        ...
        public override string ToString() {
            return string.Format("Items: {0}, PlayerSpeed: {1}, NeededWins: {2}, HostType: {3}, AllowedPauseType: {4}, PlayerStartPosition: {5}, CreatePhotoFinish: {6}", Items, PlayerSpeed, NeededWins, HostType, AllowedPauseType, PlayerStartPosition, CreatePhotoFinish);
        }
    }
}